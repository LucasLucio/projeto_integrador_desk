...
public class JanelaPesquisarPessoa extends JDialog {
    ...
    public JanelaPesquisarPessoa(List<String> lista, int x, int y) {//esse construtor é importante para receber dados 
        this.lista = lista;
        this.x = x;
        this.y = y;
    }
