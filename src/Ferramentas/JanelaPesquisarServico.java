...
import Ferramentas.FilteredJList;

public class JanelaPesquisarServico extends JDialog {
    ...
    public JanelaPesquisarServico(List<String> lista, int x, int y) {//esse construtor é importante para receber dados 
        this.lista = lista;
        this.x = x;
        this.y = y;
    }
    ...
    public void inicialize() {
        ...
        for (int i = 0; i < lista.size(); i++) {
             String[] Item = lista.get(i).split("-");
            String item  = Item[0] + " - "+ Item[1]+ " - "+ Item[2];
            list.addItem(item);
        }
